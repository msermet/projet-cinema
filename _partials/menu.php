    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                    <a class="nav-link active fs-5 fw-semibold text-warning" aria-current="page" href="#">Nouveau film</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active fs-5 fw-semibold text-warning" aria-current="page" href="#">Cinémathèque</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active fs-5 fw-semibold text-warning" aria-current="page" href="#">Les mieux notés</a>
                </li>
            </ul>
